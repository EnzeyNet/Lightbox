(function (angular) {
	...
	module.directive('nzLightbox', ['$compile', '$document', function($compile, $document) {
		return {
			priority: 1000,
			terminal: true,
			replace: true,
	...
	module.directive('nzLightboxLogic', ['nzEventHelper', function(nzEventHelper) {
		return {
	...
	module.directive('lightboxAcceptAction', ['$compile', function($compile) {
		return {
			priority: 500,
			terminal: true,
			require: '^nzLightboxLogic',
	...
	module.directive('lightboxRejectAction', ['$compile', function($compile) {
		return {
			priority: 500,
			terminal: true,
			require: '^nzLightboxLogic',
